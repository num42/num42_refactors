...
[
  ...
  {"lib/number42/refactors/ex/cond_to_case.ex", :call},
  {"lib/number42/refactors/ex/collapse_rich_case_to_with_else.ex", :call},
  ...
  {"lib/number42/refactors/ex/filter_first_to_find.ex", :call},
  ...
  {"lib/number42/refactors/ex/list_wrap_conditional.ex", :call},
  ...
  {"lib/number42/refactors/ex/split_flag_argument.ex", :call},
  {"lib/number42/refactors/ex/split_root_conditional_component.ex", :call},
