defmodule Number42.Refactors.Refactor do
  @moduledoc """
  Behaviour for AST refactor modules applied by `Number42.Refactors.Engine`.
  ...
  - Mark the module with `use Number42.Refactors.Refactor` for
    auto-discovery.
  ...
  `Number42.Refactors.Engine` reads via `__info__(:attributes)` to
